...
const BASE_URL = "http://192.168.100.223:8081"; // Replace with your local IP and backend port
...
export default function SignUpScreen() {
  ...
  const handleSignUp = async () => {
    if (!email || !password || !confirmPwd || !phone || !agreed || !birthday) {
      setError(
        t("completeAllFieldsAndAcceptTerms") ||
    ...
    try {
      ...
      else setError(t("somethingWentWrong") || "Something went wrong.");
    } finally {
      setLoading(false);
    }
  };
            ...
            <View style={styles.formContainer}>
              ...
              >
                ...
                <TextInput
                  ...
                  placeholder={t("phonePlaceholder") || "5********"}
                  placeholderTextColor={placeholder}
              ...
              >
                <Text style={{ color: birthday ? text : placeholder }}>
                  {birthday
                    ...
                    : t("chooseYourBirthday") || "Choose Your Birthday"}
                </Text>
              </Pressable>
              {showBirthdayPicker && (
                <DateTimePicker
